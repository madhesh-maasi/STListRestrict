...
!(function (a) {
  ...
  var n = { ENTER: 13, ESC: 27, F1: 112, F12: 123, LEFT: 37, RIGHT: 39 },
    o = {
      autoReset: !0,
      basic: !1,
      closable: !0,
    ...
    t = (function () {
      function m(a) {
        if (!a.__internal) {
          ...
          (l.root = document.createElement("div")),
            (l.root.className = Da.base + " " + Da.hidden + " "),
            (l.root.innerHTML = Ca.dimmer + Ca.modal),
            (l.dimmer = l.root.firstChild),
            (l.modal = l.root.lastChild),
            (l.modal.innerHTML = Ca.dialog),
            ...
            (l.body.innerHTML = Ca.content),
            (l.content = l.body.firstChild),
            (l.footer = l.body.nextSibling),
            (l.footer.innerHTML = Ca.buttons.auxiliary + Ca.buttons.primary),
            ...
            (l.buttons.primary.innerHTML = Ca.button),
          ...
          for (var m = 0; m < a.__internal.buttons.length; m += 1) {
            ...
            ya.indexOf(n.key) < 0 && ya.push(n.key),
          ...
          (a.elements = l),
            (k.resetHandler = j(a, X)),
            (k.beginMoveHandler = j(a, aa)),
            (k.beginResizeHandler = j(a, ga)),
            (k.bringToFrontHandler = j(a, B)),
            (k.modalClickHandler = j(a, R)),
            (k.buttonsClickHandler = j(a, T)),
            (k.commandsClickHandler = j(a, F)),
            (k.transitionInHandler = j(a, Y)),
            (k.transitionOutHandler = j(a, Z));
          for (var p in k.options)
            void 0 !== c.options[p]
              ? a.set(p, c.options[p])
              : v.defaults.hasOwnProperty(p)
              ? a.set(p, v.defaults[p])
              : "title" === p && a.set(p, v.defaults.glossary[p]);
      ...
      function u() {
        ...
        0 === a && document.body.className.indexOf(Da.noOverflow) >= 0
          ? (c(document.body, Da.noOverflow), w(!1))
          : a > 0 &&
            document.body.className.indexOf(Da.noOverflow) < 0 &&
            (w(!0), b(document.body, Da.noOverflow));
      }
      function w(d) {
        v.defaults.preventBodyShift &&
          document.documentElement.scrollHeight >
            document.documentElement.clientHeight &&
          (d
            ? ((Fa = xa),
              (Ea = a.getComputedStyle(document.body).top),
              b(document.body, Da.fixed),
              (document.body.style.top = -xa + "px"))
            : ((xa = Fa),
              (document.body.style.top = Ea),
              c(document.body, Da.fixed),
              t()));
      }
      function x(a, d, e) {
        "string" == typeof e && c(a.elements.root, Da.prefix + e),
          b(a.elements.root, Da.prefix + d),
          (za = a.elements.root.offsetWidth);
      }
      function y(a) {
        a.get("modal")
          ? (c(a.elements.root, Da.modeless), a.isOpen() && (pa(a), N(a), u()))
          : (b(a.elements.root, Da.modeless), a.isOpen() && (oa(a), N(a), u()));
      }
      function z(a) {
        a.get("basic")
          ? b(a.elements.root, Da.basic)
          : c(a.elements.root, Da.basic);
      }
      function A(a) {
        a.get("frameless")
          ? b(a.elements.root, Da.frameless)
          : c(a.elements.root, Da.frameless);
      }
      function B(a, b) {
      ...
      function C(a, d, e, f) {
        switch (d) {
          ...
          case "padding":
            f
              ? c(a.elements.root, Da.noPadding)
              : a.elements.root.className.indexOf(Da.noPadding) < 0 &&
                b(a.elements.root, Da.noPadding);
            break;
          case "overflow":
            f
              ? c(a.elements.root, Da.noOverflow)
              : a.elements.root.className.indexOf(Da.noOverflow) < 0 &&
                b(a.elements.root, Da.noOverflow);
            break;
          case "transition":
            x(a, f, e);
        }
      ...
      function I(a) {
        l("onmaximize", a),
          b(a.elements.root, Da.maximized),
          a.isOpen() && u(),
          l("onmaximized", a);
      }
      function J(a) {
        l("onrestore", a),
          c(a.elements.root, Da.maximized),
          a.isOpen() && u(),
          l("onrestored", a);
      }
      function K(a) {
        a.get("pinnable")
          ? b(a.elements.root, Da.pinnable)
          : c(a.elements.root, Da.pinnable);
      }
      function L(a) {
        var b = f();
      ...
      function O(a) {
        a.get("pinned")
          ? (c(a.elements.root, Da.unpinned), a.isOpen() && M(a))
          : (b(a.elements.root, Da.unpinned),
            a.isOpen() && !a.isModal() && L(a));
      }
      function P(a) {
        a.get("maximizable")
          ? b(a.elements.root, Da.maximizable)
          : c(a.elements.root, Da.maximizable);
      }
      function Q(a) {
        a.get("closable")
          ? (b(a.elements.root, Da.closable), ua(a))
          : (c(a.elements.root, Da.closable), va(a));
      }
      function R(a, b) {
      ...
      function V(a) {
        ...
        } else if (c < n.F12 + 1 && c > n.F1 - 1 && ya.indexOf(c) > -1)
          return (
            a.preventDefault(),
            a.stopPropagation(),
            S(b, function (a) {
      ...
      function X(a, b) {
        ...
        if (b && b.isModal()) {
          var d,
            ...
            f =
              e === b.elements.reset[1] ||
              (0 === b.__internal.buttons.length && e === document.body);
          f &&
            (b.get("maximizable")
            ...
            void 0 === d &&
              ("number" == typeof b.__internal.focus.element
                ...
                : e === b.elements.reset[0] &&
                  (d =
                    b.elements.buttons.primary.lastChild ||
                    b.elements.buttons.auxiliary.lastChild)),
            W(b, d);
        }
      }
      function Y(a, b) {
        clearTimeout(b.__internal.timerIn),
          ...
          c(b.elements.root, Da.animationIn);
      }
      function Z(a, b) {
        clearTimeout(b.__internal.timerOut),
          ...
          da(b),
          ja(b),
          b.isMaximized() && !b.get("startMaximized") && J(b),
          v.defaults.maintainFocus &&
            b.__internal.activeElement &&
            (b.__internal.activeElement.focus(),
      ...
      function _(a, b) {
        var c = a[La] - Ja,
          d = a[Ma] - Ka;
        Oa && (d -= document.body.scrollTop),
          (b.style.left = Math.min(Na.maxLeft, Math.max(Na.minLeft, c)) + "px"),
          (b.style.top = Oa
            ? Math.min(Na.maxTop, Math.max(Na.minTop, d)) + "px"
            : Math.max(Na.minTop, d) + "px");
      }
      function aa(a, c) {
        if (null === Qa && !c.isMaximized() && c.get("movable")) {
          ...
          if (
            ...
            if (
              ...
              (Ka = d[Ma] - f),
              c.isModal()
                ? (Ka += c.elements.modal.scrollTop)
                : c.isPinned() && (Ka -= document.body.scrollTop),
              c.get("moveBounded"))
            ) {
              var h = g,
                i = -e,
            ...
            return (
              l("onmove", c),
              (Oa = !c.isModal() && c.isPinned()),
              (Ia = c),
              Pa(d, g),
              b(document.body, Da.noSelection),
              !1
            );
          }
        }
      ...
      function ca() {
        if (Ia) {
          var a = Ia;
          (Ia = Na = null),
            c(document.body, Da.noSelection),
            c(a.elements.dialog, Da.capture),
            l("onmoved", a);
        }
      }
      function da(a) {
      ...
      function ea(a) {
        a.get("movable")
          ? (b(a.elements.root, Da.movable), a.isOpen() && qa(a))
          : (da(a), c(a.elements.root, Da.movable), a.isOpen() && ra(a));
      }
      function fa(a, b, c) {
        var e = b,
          f = 0,
        ...
        if (
          (j &&
            ...
            isNaN(Ra) || (f = document.body.offsetWidth - f - b.offsetWidth)),
          (b.style.height = i - g + Ua + "px"),
          (b.style.width = h - f + Ua + "px"),
          !isNaN(Ra))
        ) {
          var k = 0.5 * Math.abs(b.offsetWidth - Sa);
          j && (k *= -1),
            b.offsetWidth > Sa
              ? (b.style.left = Ra + k + "px")
              : b.offsetWidth >= Ta && (b.style.left = Ra - k + "px");
        }
      }
      function ga(a, c) {
        if (!c.isMaximized()) {
          ...
          if (
            ...
            l("onresize", c),
              (Qa = c),
              (Ua = c.elements.resizeHandle.offsetHeight / 2);
            var e = c.elements.dialog;
            return (
              b(e, Da.capture),
              (Ra = parseInt(e.style.left, 10)),
              (e.style.height = e.offsetHeight + "px"),
              (e.style.minHeight =
                c.elements.header.offsetHeight +
                c.elements.footer.offsetHeight +
                "px"),
              (e.style.width = (Sa = e.offsetWidth) + "px"),
              "none" !== e.style.maxWidth &&
                (e.style.minWidth = (Ta = e.offsetWidth) + "px"),
      ...
      function ha(a) {
        if (Qa) {
          ...
          "touchmove" === a.type
            ...
            : 0 === a.button && (b = a),
            b &&
              fa(b, Qa.elements.dialog, !Qa.get("modal") && !Qa.get("pinned"));
        }
      }
      function ia() {
        if (Qa) {
      ...
      function ka(a) {
        a.get("resizable")
          ? (b(a.elements.root, Da.resizable), a.isOpen() && sa(a))
          : (ja(a), c(a.elements.root, Da.resizable), a.isOpen() && ta(a));
      }
      function la() {
      ...
      function ma(b) {
        1 === p.length &&
          (q(a, "resize", la),
          q(document.body, "keyup", U),
          q(document.body, "keydown", V),
          q(document.body, "focus", X),
          q(document.documentElement, "mousemove", ba),
          q(document.documentElement, "touchmove", ba),
          q(document.documentElement, "mouseup", ca),
          q(document.documentElement, "touchend", ca),
          q(document.documentElement, "mousemove", ha),
          q(document.documentElement, "touchmove", ha),
          q(document.documentElement, "mouseup", ia),
          q(document.documentElement, "touchend", ia)),
          q(
      ...
      function na(b) {
        1 === p.length &&
          (r(a, "resize", la),
          r(document.body, "keyup", U),
          r(document.body, "keydown", V),
          r(document.body, "focus", X),
          r(document.documentElement, "mousemove", ba),
          r(document.documentElement, "mouseup", ca),
          r(document.documentElement, "mousemove", ha),
          r(document.documentElement, "mouseup", ia)),
          r(
            b.elements.commands.container,
            "click",
            b.__internal.commandsClickHandler
        ...
        resizeTo: function (a, b) {
          ...
          if (!isNaN(c) && !isNaN(d) && !0 === this.get("resizable")) {
            ...
            "none" !== f.style.maxWidth &&
              (f.style.minWidth = (Ta = f.offsetWidth) + "px"),
          ...
          if ("set" === d.op) {
            if (d.items.length > 0)
              for (
                ...
                g.found ||
                  void 0 === this.settings ||
                  D(this, this.settings, e, g.key, g.value);
              }
            return this;
          }
        },
          ...
          if ((m(this), this.__internal.isOpen)) {
            ...
            if (
              ...
              document.body.hasAttribute("tabindex") ||
                document.body.setAttribute("tabindex", (Aa = "0")),
              ...
              this.get("startMaximized")
                ? this.maximize()
                : this.isMaximized() && J(this),
              N(this),
              c(this.elements.root, Da.animationOut),
              b(this.elements.root, Da.animationIn),
            ...
            (za = this.elements.root.offsetWidth),
              c(this.elements.root, Da.hidden),
        ...
        close: function () {
          return (
            this.__internal.isOpen &&
              !1 !== l("onclosing", this) &&
              (na(this),
              c(this.elements.root, Da.animationIn),
              b(this.elements.root, Da.animationOut),
              clearTimeout(this.__internal.timerOut),
              (this.__internal.timerOut = setTimeout(
                this.__internal.transitionOutHandler,
                s.supported ? 1e3 : 100
              )),
              b(this.elements.root, Da.hidden),
              (za = this.elements.modal.offsetWidth),
              ...
              u()),
            p.length || "0" !== Aa || document.body.removeAttribute("tabindex"),
            this
          );
        },
        ...
        return o({
          ...
          push: function (a, c) {
            if (!this.__internal.pushed) {
              ...
              return (
                (this.__internal.closeButton = v.defaults.notifier.closeButton),
          ...
          delay: function (a) {
            if (
              ...
              (this.__internal.delay =
                void 0 === a || isNaN(+a) ? u.__internal.delay : +a),
